...
def convert_det(DET, ann_dir, save_dir):
    ...
    vid_train_img_list = "/ds-av/public_datasets/imagenet/raw/ImageSets/DET/val.txt"
    ...
    for img_name in tqdm(vid_train_img_names):
        ...
        xml_path = osp.join(ann_dir, 'Annotations/DET/val',
    ...
    for sub_set in tqdm(dataset_sets):
        ...
        sub_set_base_path = osp.join(ann_dir, 'Annotations/DET/val', sub_set)
