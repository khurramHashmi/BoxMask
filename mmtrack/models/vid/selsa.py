...
'''
CHANGE WHEN TRAINING WITH YOUTUBE_VIS DATASET
LINE NUMBER 143 AND 190
 Ref_image and Ref_image meta are not coming as they do in imagenet dataset
'''
import warnings
...
class SELSA(BaseVideoDetector):
    ...
    def forward_train(self,
        ...
        #Defualt rpn with mask variable is false
        rpn_with_mask = False
        ...
        if self.detector.with_rpn:
            ...
            for name, _ in self.detector.rpn_head.named_modules():
                if name == "loss_mask":
                    rpn_with_mask=True
                    break
            if rpn_with_mask:
