...
Imported a function from mmcv imshow_det_bboxes and paste it to here to customize visualizations
function is placed at the bottom, if default from mmcv is required just comment the function.
'''
...
from mmcv.visualization.color import *
import mmcv
import numpy as np
import torch
