...
def main():
    ...
    #     #     print(data["image_metas"])
    #     if index > 10: #130900
    #         for x in data["img_metas"][0]:
    #             print(x)
    #
    # import sys
    # sys.exit()

    # CHANGE CODE ENDSHERE
    ...
    if rank == 0:
        ...
        if args.format_only:
            ...
            #CHANGE IN CODE SO THAT LIST CAN BE EXTRACTED FROM DICTIONARY IN CASE OF RESULTS ON VIDEOS
            # print(f"Resulsts : {len(outputs)} and {outputs.keys()}")
            dataset.format_results(outputs['det_bboxes'], **kwargs)
            #CHANGE IN CODE ENDS HERE
