...
data = dict(
    ...
    train=[
        ...
        dict(
            ...
            load_as_video=False,
            ann_file=
            data_ann_root+'imagenet_det_30plus1cls.json',
    ...
    test=dict(
        ...
        pipeline=test_pipeline,
        test_mode=True))
optimizer = dict(type='SGD', lr=0.02/num_gpus, momentum=0.9, weight_decay=0.0001)
optimizer_config = dict(grad_clip=dict(max_norm=35, norm_type=2))
checkpoint_config = dict(interval=1)
log_config = dict(interval=5000, hooks=[dict(type='TextLoggerHook')])
