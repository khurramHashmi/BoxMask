...
num_gpus=8
lr_factor = 8/num_gpus
# optimizer

log_config = dict(_delete_=True, interval=5000, hooks=[dict(type='TextLoggerHook')])

optimizer = dict(type='SGD', lr=0.01/lr_factor, momentum=0.9, weight_decay=0.0001)
